...
const personalTasks: Task[] = [
  { id: 'p1', project_id: 'personal', title: 'PnL sheet', status: 'todo', priority: 'urgent_important', is_urgent: true, is_important: true, due_date: '2025-01-15', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p2', project_id: 'personal', title: 'Legal notice to builder indiabulls', status: 'todo', priority: 'urgent_important', is_urgent: true, is_important: true, due_date: '2025-01-10', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p3', project_id: 'personal', title: 'Company clouser', status: 'todo', priority: 'urgent_not_important', is_urgent: true, is_important: false, due_date: '2025-12-31', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p4', project_id: 'personal', title: 'Increase card limit sbi', status: 'todo', priority: 'urgent_not_important', is_urgent: true, is_important: false, due_date: '2024-12-15', created_at: new Date().toISOString(), updated_at: new Date().toISOString() }, // OVERDUE
  { id: 'p5', project_id: 'personal', title: 'Workout routine', status: 'todo', priority: 'not_urgent_important', is_urgent: false, is_important: true, due_date: '2025-11-30', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'p10', project_id: 'personal', title: 'Propretiorship account', status: 'todo', priority: 'urgent_important', is_urgent: true, is_important: true, due_date: '2024-10-01', created_at: new Date().toISOString(), updated_at: new Date().toISOString() }, // OVERDUE
  { id: 'p11', project_id: 'personal', title: 'ICICI card limit increase', status: 'todo', priority: 'urgent_not_important', is_urgent: true, is_important: false, due_date: '2025-02-28', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
